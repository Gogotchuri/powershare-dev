<div class="form-group">
    <div class="col-xs-9">
        <div style="border: 1px solid #e5e5e5; height: 50vh; overflow: auto; padding: 10px;">
            <p>Terms and Conditions</p>
            <p>Last updated: ----------------------</p>
            <p>These Terms and Conditions (&quot;Terms&quot;, &quot;Terms and Conditions&quot;) govern your relationship
                with Powershare.fund website (the &quot;Service&quot;) operated by Power Share Foundation JSC (&quot;us&quot;,
                &quot;we&quot;, or &quot;our&quot;).
            </p>
            ...
            <p>Our Service allows you to post, link, store, share and otherwise make available certain information,
                text, graphics, videos, or other material (&quot;Content&quot;). You are responsible for the Content
                that you post to the Service, including its legality, reliability, and appropriateness.
            </p>
            <p>By posting Content to the Service, you grant us the right and license to use, modify, perform, display,
            ...
            <p>We respect the intellectual property rights of others. It is our policy to respond to any claim that
                Content posted on the Service infringes the copyright or other intellectual property infringement (&quot;Infringement&quot;)
                of any person.
            </p>
            <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work
                ...
                Service, you must submit your notice in writing to the attention of &quot;Copyright Infringement&quot;
                of <a href="mailto:info@powershare.fund">info@powershare.fund</a>&nbsp;and include in your notice a
            ...
            <p>The Service and its original content (excluding Content provided by users), features and functionality
                are and will remain the exclusive property of Power Share Foundation JSC and its licensors. The Service
                is protected by copyright, trademark, and other laws of both the Georgia and foreign countries. Our
                trademarks and trade dress may not be used in connection with any product or service without the prior
                written consent of Power Share Foundation JSC.
            </p>
            <h2>Links To Other Web Sites</h2>
            <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by
                Power Share Foundation JSC.
            </p>
            <p>Power Share Foundation JSC has no control over, and assumes no responsibility for, the content, privacy
                policies, or practices of any third party web sites or services. You further acknowledge and agree that
                Power Share Foundation JSC shall not be responsible or liable, directly or indirectly, for any damage or
            ...
            <p>In no event shall Power Share Foundation JSC, nor its directors, employees, partners, agents, suppliers,
            ...
            <p>Power Share Foundation JSC its subsidiaries, affiliates, and its licensors do not warrant that a) the
            ...
            <h2>Governing Law</h2>
            <p>These Terms shall be governed and construed in accordance with the laws of Georgia (Civil code of
            ...
            <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision
                is material we will try to provide at least 30 days&rsquo; notice prior to any new terms taking effect.
