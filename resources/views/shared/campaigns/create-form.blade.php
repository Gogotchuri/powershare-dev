...
{{--        @push('scripts-stack')--}}
        <script src="/js/blueimp/vendor/jquery.ui.widget.js" defer></script>
        <script src="/js/blueimp/jquery.iframe-transport.js" defer></script>
        <script src="/js/blueimp/jquery.fileupload.js" defer></script>
        <script defer>
